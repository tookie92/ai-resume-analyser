        ...
        <section className='main-section'>
            <div className='page-heading py-16'>
                ...
                {isProcessing ? (
                    ...
                    <h2>Drop your resume for an ATS and improvment tips</h2>
                )}
                {!isProcessing &&(
                    <form id="upload-form" onSubmit={handleSubmit} className='flex flex-col gap-4 mt-8' >
                        <div className='form-div'>
                            ...
                            <input type='text' name='company-name' id="company-name" className='input-field' placeholder="Company Name"/>
                        </div>
                        <div className='form-div'>
                            <label htmlFor="job-title">
                                Job Title
                            </label>
                            <input type='text' name='job-title' id="job-title" className='input-field' placeholder="Job Title"/>
                        </div>
                        <div className='form-div'>
                            <label htmlFor="job-description">
                                Job Description
                            </label>
                            <textarea rows={5} name='job-description' id="job-description" className='input-field' placeholder="Job Descritpion"/>
                        </div>
                        <div className='form-div'>
